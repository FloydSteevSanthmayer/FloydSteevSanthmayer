...
<p align="center">
  <!-- LinkedIn -->
  <a href="https://www.linkedin.com/in/floydsteevsanthmayer" target="_blank" rel="noopener noreferrer">
 ...
 <a href="https://mail.google.com/mail/?view=cm&to=floydsteev.santhmayer@gmail.com" target="_blank">
  ...
  <p align="right">
  <img src="https://komarev.com/ghpvc/?username=FloydSteevSanthmayer&style=flat" height="19"/>
</p>
...
## 🧰 Tech & Tools
`Python` • `pandas` • `NumPy` • `SQL` • `PostgreSQL` • `Power BI` • `Tableau` • `Excel` • `Git` • `Docker` • `GitHub`
